...
def read_data(file_loc: str) -> DataFrame:
    ...
    Raises: None
    """
    df_event_logs = read_json(file_loc, lines=True)
    logger.info(f"Raw Data dimension: {df_event_logs.shape}")
    return df_event_logs
    ...
    def get_db_config(config_file: str) -> dict:
        ...
        with open(config_file, "r") as data:
            try:
                ...
                return read_db_config["EventSource"]["outputs"]["dev"]
...
def commit_and_close_db_connection(conn: Connection) -> None:
